...
tags: 图
categories: 数据结构学习
cover: https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/River%20&%20Faye.png?x-oss-process=style/blog
...
![20231130163839](https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/20231130163839.png?x-oss-process=style/blog)
...
![img](https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/v2-09bd69e515de6332571f48cfd2b27cac_b.jpg?x-oss-process=style/blog)
...
![img](https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/d6811dc195984c0f82387ea8e8391967.png?x-oss-process=style/blog)

它的顶点节点拥有一个data域储存和顶点相关的信息以及两条链域，分别指向以该顶点为弧头或弧尾的第一个弧节点。

弧结点的数据类型如下图所示：

![img](https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/51d7ffbdcc6d467485967deb78ba438d.png?x-oss-process=style/blog)

弧尾结点存储该弧尾结点所在图中的位置，弧头结点同理；弧上信息指示权值等弧数据；hlink指向与该弧有相同弧头的弧结点，tlink指向与该弧有相同弧尾的弧结点

结合这些给出十字链表的示意图：

![img](https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/4f87bee55ba5485f8d9d892bbe4528f7.png?x-oss-process=style/blog)
...
![img](https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/048e5367b8e04499ab0d6d320310b78d.png?x-oss-process=style/blog)
...
![img](https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/af8af348f00409d2a3efc0ec3c7c0c73.gif?x-oss-process=style/blog)
...
![有向无环图](https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/f805b876f56a464895ba1c78db777c7d.png?x-oss-process=style/blog)
...
![River & Faye](https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/River%20&%20Faye.png?x-oss-process=style/blog)
