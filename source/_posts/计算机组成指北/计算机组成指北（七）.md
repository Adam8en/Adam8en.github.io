...
tags: 
  ...
  - 微指令编码方式
categories: 计算机组成指北
cover: https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/C10AD1752A521C3C297E7D81400952F1.jpg?x-oss-process=style/blog
...
<img src="https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/image-20240706141431460.png?x-oss-process=style/blog" alt="image-20240706141431460" style="zoom:50%;" />

其中，CU发出的**控制信号的先后关系与时间点的确定**，由节拍发生器确定。如果你忘记了节拍的概念，去复习第九章的多级时序系统，或者参考下图。

<img src="https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/image-20240706141948426.png?x-oss-process=style/blog" alt="image-20240706141948426" style="zoom:33%;" />
...
![组合程序设计表2.drawio](https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/%E7%BB%84%E5%90%88%E7%A8%8B%E5%BA%8F%E8%AE%BE%E8%AE%A1%E8%A1%A82.drawio.svg?x-oss-process=style/blog)
...
![image-20240706160526603](https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/image-20240706160526603.png?x-oss-process=style/blog)
...
<img src="https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/image-20240706163101937.png?x-oss-process=style/blog" alt="image-20240706163101937" style="zoom:50%;" />
...
<img src="https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/image-20240706163801863.png?x-oss-process=style/blog" alt="image-20240706163801863" style="zoom:50%;" />
...
<img src="https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/image-20240706164304889.png?x-oss-process=style/blog" alt="image-20240706164304889" style="zoom:50%;" />
...
<img src="https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/image-20240706171522749.png?x-oss-process=style/blog" alt="image-20240706171522749" style="zoom:50%;" />
...
<img src="https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/image-20240706171918592.png?x-oss-process=style/blog" alt="image-20240706171918592" style="zoom:50%;" />
...
<img src="https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/image-20240706172325957.png?x-oss-process=style/blog" alt="image-20240706172325957" style="zoom:50%;" />
...
4. 分支转移
   ...
   <img src="https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/image-20240706172828439.png?x-oss-process=style/blog" alt="image-20240706172828439" style="zoom:50%;" />

5. 通过测试网络

   可以用于微程序在小范围内的跳转

   <img src="https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/image-20240706172904041.png?x-oss-process=style/blog" alt="image-20240706172904041" style="zoom:50%;" />
...
<img src="https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/image-20240706173047643.png?x-oss-process=style/blog" alt="image-20240706173047643" style="zoom:50%;" />
...
<img src="https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/image-20240706194837556.png?x-oss-process=style/blog" alt="image-20240706194837556" style="zoom:50%;" />
...
<img src="https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/image-20240706195032652.png?x-oss-process=style/blog" alt="image-20240706195032652" style="zoom:50%;" />
...
- 微指令字长的优化
  ...
  <img src="https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/image-20240706203838160.png?x-oss-process=style/blog" alt="image-20240706203838160" style="zoom:50%;" />
...
- 定义微指令操作字段每一位的操作
  ...
  <img src="https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/image-20240706204036976.png?x-oss-process=style/blog" style="zoom:50%;" />

##### 编写微指令码点

规定每一位的操作如下（部分）：

![image-20240706204256674](https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/image-20240706204256674.png?x-oss-process=style/blog)

画出码点图

![image-20240706204429307](https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/image-20240706204429307.png?x-oss-process=style/blog)
...
![C10AD1752A521C3C297E7D81400952F1](https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/C10AD1752A521C3C297E7D81400952F1.jpg?x-oss-process=style/blog)
