...
<img src="https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/image-20240225205435811.png" alt="image-20240225205435811" style="zoom:67%;" />
...
<img src="https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/20240225210457.png" style="zoom:67%;" />
...
<img src="https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/image-20240225211009340.png" alt="image-20240225211009340" style="zoom:50%;" />
...
<img src="https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/image-20240225211424459.png" alt="image-20240225211424459" style="zoom:50%;" />

由于写入的模块是`comment.php`，需要在主页加载一次评论区后才能成功执行，然后再访问`/wordpress/shell.php`，可以看到成功写入webshell。

<img src="https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/image-20240225211745550.png" alt="image-20240225211745550" style="zoom:50%;" />
...
<img src="https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/image-20240225212359378.png" alt="image-20240225212359378" style="zoom:50%;" />
...
<img src="https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/20240225213448.png" style="zoom:67%;" />
...
![image-20240225213739339](https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/image-20240225213739339.png)
...
![](https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/20240225214348.png)
...
![](https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/20240225214810.png)

成功拿下入口一。

![](https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/20240225214909.png)
...
![](https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/20240225215002.png)
...
![image-20240225215638009](https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/image-20240225215638009.png)
...
<img src="https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/image-20240225220038599.png" alt="image-20240225220038599" style="zoom:50%;" />
...
![db45bae4f290e573f6dab997c22c1d5](https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/db45bae4f290e573f6dab997c22c1d5.png)

其实还有一个看似不那么重要却十分致命的问题：**我们如何获取数据库的文件路径？**

切到先前的php探针界面，这里已经列出了数据库的绝对路径，顺便告诉了我们靶机系统是windows。

![image-20240225222112963](https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/image-20240225222112963.png)
...
![image-20240225221638860](https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/image-20240225221638860.png)
...
<img src="https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/image-20240225223137229.png" alt="image-20240225223137229" style="zoom:50%;" />
...
![](https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/20240225223257.png)

#### 软件免杀

蚁剑上线后输入`whoami`查看用户权限。

![image-20240225225125189](https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/image-20240225225125189.png)
...
<img src="https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/20240225225335.png" style="zoom:50%;" />

上线失败，猜测有杀毒软件拦截。

<img src="https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/image-20240225225453267.png" alt="image-20240225225453267" style="zoom: 67%;" />
...
![](https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/20240225225700.png)
...
![image-20240225230312978](https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/image-20240225230312978.png)
...
<img src="https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/wk8ve2c9da.jpeg" alt="wk8ve2c9da" style="zoom:67%;" />
...
<img src="https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/5a25ef56a3ae46aad769882b0ab6034.png" alt="5a25ef56a3ae46aad769882b0ab6034" style="zoom:67%;" />
...
<img src="https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/e4ffc2eba9406aa3938775b2e0e8e2a.png" alt="e4ffc2eba9406aa3938775b2e0e8e2a" style="zoom:67%;" />
...
<img src="https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/6012149ef1407f3a30d6e441a11c3e2.png" alt="6012149ef1407f3a30d6e441a11c3e2" style="zoom:50%;" />
...
<img src="https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/e9ba90a4123e3a489900af4d0e0d3fe.png" alt="e9ba90a4123e3a489900af4d0e0d3fe" style="zoom:50%;" />
