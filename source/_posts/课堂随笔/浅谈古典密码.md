...
categories: 课堂随笔
cover: https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/101268797_p0.jpg
...
3. 构造方法：从左至右，从上至下依次填入关键词的字母（去除重复的字母），然后再以字母表顺序依次填入其他的字母。加密时字母I和J被算作一个字母
   ...
   ![](https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/image-20240623140740165.png)
...
![image-20240623143319986](https://adam8en-blog-image.oss-cn-guangzhou.aliyuncs.com/image-20240623143319986.png)
